...
namespace BaconGameJam.Win7.Views.Particles
{
    ...
    public abstract class ParticleSystem
    {
        ...
        // Random number generator used to vary the particles
        ...
        readonly Queue<Particle> freeParticles;
        ...
        {
            get { return this.freeParticles.Count; }
        }
        ...
        /// <param name="random">Random number generator used to vary the particles</param>
        ...
        protected ParticleSystem(Random random, int howManyEffects)
        {
            this.random = random;
            ...
            this.particles = new Particle[this.howManyEffects];
            this.freeParticles = new Queue<Particle>(this.howManyEffects);
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            // load the texture....
            this.texture = content.Load<Texture2D>(this.textureFilename);
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                this.random.Next(this.minNumParticles, this.maxNumParticles);

            // create that many particles, if you can.
            for (int i = 0; i < numParticles && this.freeParticles.Count > 0; i++)
            {
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            Vector2 direction = this.PickRandomDirection();

            // pick some random values for our particle
            float velocity = this.RandomBetween(this.minInitialSpeed, this.maxInitialSpeed);
            float rotation = this.RandomBetween(0, MathHelper.TwoPi);
            float acceleration = this.RandomBetween(this.minAcceleration, this.maxAcceleration);
            float lifetime = this.RandomBetween(this.minLifetime, this.maxLifetime);
        ...
        {
            float angle = this.RandomBetween(0, MathHelper.TwoPi);
        ...
        {
            float delta = max - min;
            return (float)(min + this.random.NextDouble() * delta);
        }
