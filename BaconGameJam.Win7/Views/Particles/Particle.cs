...
namespace BaconGameJam.Win7.Views.Particles
{
    ...
    public class Particle
    {
        ...
        {
            get { return this.timeSinceStart; }
            set { this.timeSinceStart = value; }
        }
        ...
        public bool Active
        {
            get { return this.TimeSinceStart < this.Lifetime; }
        }

        
        // initialize is called by ParticleSystem to set up the particle, and prepares
        // the particle for use.
        public void Initialize(Vector2 position, Vector2 velocity, float rotation, Vector2 acceleration,
